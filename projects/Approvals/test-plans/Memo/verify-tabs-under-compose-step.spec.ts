// AUTO-RECORDED from test-plans/Memo/verify-tabs-under-compose-step.md
// Source: Azure DevOps test plan #100853, suite #100854, test case #102639
...
test('TC-01 — Verify user can click on tabs under compose step', async ({ page }) => {
  ...
  // STEP 2: CLICK the "Click to change view mode" control to switch from Live mode to Latest mode.
  ...
  // STEP 13: CLICK each of the available tabs in turn and confirm it becomes active
