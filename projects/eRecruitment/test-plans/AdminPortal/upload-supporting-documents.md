# Test Plan: ADMINPORTAL-102827 — Upload Supporting Documents
...
| ADO Suite | Not currently linked to a suite in Test Plan #99437 (work item #102827 has no `Tested By` relation) — same situation as #102822 and #102826. |
| ADO Test Case | [#102827](https://dev.azure.com/boxfusion/pd-recruitment/_workitems/edit/102827) — Upload Supporting Documents |

## Objective
> Validate the Documentation step of the Job Posting wizard: after completing Job Information Summary and Output and Competencies (steps 3-17, shared with #102822/#102826), upload a document into the "Supporting Documents" box, confirm it appears in the file list with no errors, click Next to advance to the Confirmation stepper, and additionally verify the Replace and Delete controls on the uploaded attachment (not explicit ADO steps, added at the requester's instruction to cover the full attachment lifecycle).
...
### TC-02 — Complete Job Information Summary and advance to Output and Competencies (ADO #102827 steps 3-12)

*Shared setup, identical to `create-job-posting-valid.md` — expand Workflows, My Items, Create New → JobPosting, fill Recruiter/Job Info Summary fields, click Next.*
...
### TC-03 — Complete Output and Competencies and advance to Documentation (ADO #102827 steps 13-17)
...
### TC-04 — Click inside the Supporting Documents upload box (ADO #102827 step 18)

- **Steps:**
  1. CLICK the Supporting Documents upload area
...
### TC-05 — Select a valid file and upload (ADO #102827 step 19)
...
### TC-06 — Assert file appears in the Supporting Documents list (ADO #102827 step 20)
...
### TC-07 — Verify no error message is displayed (ADO #102827 step 21)
...
### TC-08 — Click the newly enabled Next button (ADO #102827 step 22)

- **Steps:**
  1. CLICK the Next button
- **Expected result:** The wizard transitions smoothly to Stepper 4 (Confirmation), Stepper 3 updates to a completed visual state, and no network errors are thrown
- **Assertions:**
  - [x] ASSERT (BLOCKING) "Confirmation" step is active

---

### TC-09 — Replace the uploaded document (additional coverage, not an explicit ADO step)
...
### TC-10 — Delete the uploaded document (additional coverage, not an explicit ADO step)
...
- **Expected result:** The attachment is removed from the Supporting Documents list
- **Assertions:**
