// AUTO-RECORDED from test-plans/AdminPortal/verify-edit-internal-external-applicant.md
// Source: Azure DevOps project pd-recruitment, test case #106534 "Verify
// Edit internal/External Applicant" (work item rev 2). The .md plan is
...
// ADO; the Internal/External dropdown's option list (with "Current
// Employee" selected) shows "External Applicant", "Past Employee",
// "Recruitment Agency". TC-10 clicks Save for real, permanently changing
// the candidate's Internal/External status — confirmed with the
...
function internalExternalSelect(page: Page) {
  return page.locator('label', { hasText: 'Internal/External' }).locator('xpath=../..').locator('.ant-select').first();
}
...
test.describe('ADMINPORTAL-106534 — Verify Edit internal/External Applicant', () => {
  ...
  test('TC-08: Click on the Internal/External dropdown', async ({ page }) => {
    ...
    await expect(page.getByText('External Applicant', { exact: true }).first()).toBeVisible();
