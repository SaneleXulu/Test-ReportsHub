# Test Plan: HOME-106559 — Verify Valid Job Title and Location
...
| ADO Test Case | [#106559](https://dev.azure.com/boxfusion/pd-recruitment/_workitems/edit/106559) — Verify valid Job title and location |
...
>
> **Note:** ADO test case #106559 is titled and stepped identically to [#106557](../Home/verify-valid-job-title-and-location.md) (same suite, same steps 3-7). This plan/spec is kept as a separate file purely to preserve 1:1 ADO test-case provenance in reports.
...
### TC-02 — Click on Home menu item (ADO #106559 step 3)
...
### TC-03 — Leave job title text area blank (ADO #106559 step 4)
...
### TC-04 — Click on location dropdown (ADO #106559 step 5)
...
### TC-05 — Select a location option, e.g. Head Office (ADO #106559 step 6)
...
### TC-06 — Click on Search button (ADO #106559 step 7)
